                        ...
                        <div class="flex flex-wrap">
                            <div class="grid grid-cols-6 w-full gap-2">
                                ...
                                <div class="col-end-7 col-span-2 ...">
                                    <div class="w-full px-3 mb-6">
                                        <input class="input-recherche shadow-box" type="search" placeholder="Recherche" v-model="searchCompetence">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        computed: {
            filtered: function() {
                ...
                search = search.filter(function(item) {
                    if (item.blocs.toLowerCase().indexOf(searchComposante) !== -1 || item.blocs.toUpperCase().indexOf(searchComposante) !== -1) {
                        return item;
                    }
                })
                return search;
