                        ...
                        <div class="flex flex-wrap ">
                            <div class="grid grid-cols-6 w-full gap-2">
                                ...
                                <div class="col-end-7 col-span-2 ...">
                                    <div class="w-full px-3 mb-6">
                                        <input class="input-recherche shadow-box" type="search" placeholder="Recherche">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="shadow-box w-full rounded-lg">
                                <thead>
                                    <tr class="inter font-semibold text-xl border-b my-3 text-theme-bleu-marine">
                                        ...
                                        <th scope="col">Nb année</th>
                                        <th scope="col">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="item in diplome" :key="item">
                                        <td>{{ item.libelleDiplome }}</td>
                                        <td>{{ item.nbAnneeDiplome }}</td>
                                        <td>
                                            <div class="px-6 py-4 flex justify-center items-stretch text-gray-900">
                                                ...
                                                <span v-on:click="deleteDiplome(item.id)">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">   
