<template>
    <div class="container w-auto">
        ...
        <h1>Liste des types de diplôme</h1>
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="w-full table-auto divide-y divide-gray-200">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Diplôme</th>
                    ...
                    <tr class="hover:bg-gray-100" v-for="item in diplome" :key="item">
                        <th scope="row" class="px-6 py-4 whitespace-nowrap">{{ item.libelleDiplome }}</th>
