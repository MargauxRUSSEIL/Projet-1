                            ...
                            <div class="grid grid-cols-6 w-full gap-2">
                                ...
                                <div class="col-end-7 col-span-2">
                                    <div class="w-full px-3 mb-6">
                                        <input class="input-recherche shadow-box md:p-2 sm:p-2 xl:p-32 lg:p-32 ml-28" type="search" placeholder="Recherche" v-model="searchMention">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="shadow-box w-full rounded-lg">
                                <thead>
                                    <tr class="inter font-semibold text-xl border-b my-3 text-theme-bleu-marine">
                                        ...
                                        <th scope="col">Domaines Associés</th>
                                    ...
                                    <tr v-for="item in filtered" :key="item">
                                        ...
                                        <td>
                                            <div class="px-6 py-4 flex justify-center items-stretch text-gray-900">
                                                ...
                                                <span role="button" v-on:click="deleteMention(item.id)">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            download: function() {
                const data = XLSX.utils.json_to_sheet(this.mention);
                const wb = XLSX.utils.book_new();
                XLSX.utils.book_append_sheet(wb, data, "data");
                XLSX.writeFile(wb, "mention.xlsx");
            },
