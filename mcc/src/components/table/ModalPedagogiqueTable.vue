                ...
                <div class="grid grid-cols-6 w-full gap-2">
                    <div class="col-start-1 col-end-3 ...">
                        <div class="w-full px-3 mb-6">
                            <router-link :to="{ name: 'newPedagogique' }">
        ...
        <div class="my-12 md:mx-6 sm:mx-6 xl:mx-56 lg:mx-56" v-else>
                            ...
                            <table class="shadow-box w-full rounded-lg">
                                <thead>
                                    <tr class="inter font-semibold text-xl border-b my-3 text-theme-bleu-marine">
                                        <th scope="col">Libellé Modalité Pédagogique</th>
                                        <th scope="col"></th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <div class="px-6 py-4 flex justify-center items-stretch text-gray-900">
                                              <router-link :to="{ name: 'updateModalitePedagogique', params: { id: item.id }}">
                                               <svg role="img" aria-label="Modifier" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <span role="button" v-on:click="deleteModalitePedagogique(item.id)">
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="w-full table-auto divide-y divide-gray-200">
                    ...
                    <tr>
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">libellé Modalité Pédagogique</th>
                    ...
                    <tr class="hover:bg-gray-100" v-for="item in filtered" :key="item">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="text-sm text-gray-900">
                                <router-link :to="{ name: 'updatePedagogique', params: { id: item.id }}">
