                                ...
                                <tr v-for="item in filtered" :key="item">
                                    ...
                                    <td>
                                        <div class="px-6 py-4 flex justify-center items-stretch text-gray-900">
                                            ...
                                            <span role="button" v-on:click="deleteParcours(item.id)">
        ...
        computed: {
            filtered: function() {
                ...
                search = search.filter(function(item) {
                    if (item.libelleParcoursApogee.toLowerCase().indexOf(searchParcours) !== -1 || item.libelleParcoursApogee.toUpperCase().indexOf(searchParcours) !== -1) {
                        return item;
                    }
                })
                return search;
