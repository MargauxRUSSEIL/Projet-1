                ...
                <div class="grid grid-cols-6 w-full gap-2">
                    <div class="col-start-1 col-end-3 ...">
                        <div class="w-full px-3">
                            <router-link :to="{ name: 'newSemestre' }">
                                <span class="bg-red-500 hover:bg-red-700 text-white py-2 px-4 rounded font-semibold text-sm" type="button">Ajouter un semestre</span>
                            </router-link>
                        </div>
                    </div>
            ...
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                <table class="w-full table-auto divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-100" v-for="item in filtered" :key="item">
                        <th scope="row" class="px-6 py-4 whitespace-nowrap">{{ item.libelle }}</th>
