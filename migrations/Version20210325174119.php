 ...
 */
final class Version20210325174119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mcc ADD niveau_id INT DEFAULT NULL, DROP niveau');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mcc ADD niveau VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, DROP niveau_id');
    }
}
