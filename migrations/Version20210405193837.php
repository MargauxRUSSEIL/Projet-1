 ...
 */
final class Version20210405193837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, workflow_id INT DEFAULT NULL, mention_id INT DEFAULT NULL, structure_haute INT DEFAULT NULL, code_diplome VARCHAR(255) DEFAULT NULL, ecole_doctorale VARCHAR(255) DEFAULT NULL, contact VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, type_formation VARCHAR(255) DEFAULT NULL, vdi VARCHAR(255) DEFAULT NULL, statuts VARCHAR(255) DEFAULT NULL, INDEX IDX_404021BF2C7C2CBA (workflow_id), INDEX IDX_404021BF7A4147F0 (mention_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
