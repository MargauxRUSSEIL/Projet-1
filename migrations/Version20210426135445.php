 ...
 */
final class Version20210426135445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE session_unique (id INT AUTO_INCREMENT NOT NULL, session_unique_has_controle_connaissance_id INT DEFAULT NULL, type_epreuve VARCHAR(255) DEFAULT NULL, regle_calcul VARCHAR(255) DEFAULT NULL, session VARCHAR(255) DEFAULT NULL, INDEX IDX_DFC95C2ECCA5EC1C (session_unique_has_controle_connaissance_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
