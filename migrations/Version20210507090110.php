 ...
 */
final class Version20210507090110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE composante (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D8E84C8A4D60759 (libelle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, code_apogee VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etape (id INT AUTO_INCREMENT NOT NULL, workflow_id INT DEFAULT NULL, intitule VARCHAR(255) NOT NULL, statut VARCHAR(255) DEFAULT NULL, date_validation DATETIME DEFAULT NULL, date_limite DATETIME NOT NULL, INDEX IDX_285F75DD2C7C2CBA (workflow_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE formation (id INT AUTO_INCREMENT NOT NULL, localisation_id INT DEFAULT NULL, type_diplome_id INT DEFAULT NULL, domaine_id INT DEFAULT NULL, mention_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, user_id INT DEFAULT NULL, composante_id INT DEFAULT NULL, structure_haute INT DEFAULT NULL, code_diplome VARCHAR(255) DEFAULT NULL, ecole_doctorale VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, vdi VARCHAR(255) DEFAULT NULL, libelle VARCHAR(255) NOT NULL, statut VARCHAR(255) DEFAULT NULL, INDEX IDX_404021BFC68BE09C (localisation_id), INDEX IDX_404021BF3BFB8FC7 (type_diplome_id), INDEX IDX_404021BF4272FC9F (domaine_id), INDEX IDX_404021BF7A4147F0 (mention_id), INDEX IDX_404021BFB3E9C81 (niveau_id), INDEX IDX_404021BFA76ED395 (user_id), INDEX IDX_404021BFAC12F1AD (composante_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE localisation (id INT AUTO_INCREMENT NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal INT NOT NULL, UNIQUE INDEX UNIQ_BFD3CE8FC35F0816 (adresse), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mcc (id INT AUTO_INCREMENT NOT NULL, parcours_id INT DEFAULT NULL, mention_id INT DEFAULT NULL, formation_id INT DEFAULT NULL, departement VARCHAR(255) NOT NULL, annee DATETIME NOT NULL, statut VARCHAR(255) DEFAULT NULL, niveau VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_252589E76E38C0DB (parcours_id), INDEX IDX_252589E77A4147F0 (mention_id), INDEX IDX_252589E75200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mention (id INT AUTO_INCREMENT NOT NULL, domaine_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_E20259CD4272FC9F (domaine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE modalite_formation (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_177E55B1A4D60759 (libelle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE modalite_pedagogique (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_96625500A4D60759 (libelle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE modalite_recrutement (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EC00EC8CA4D60759 (libelle), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nb_groupe_type_cours (id INT AUTO_INCREMENT NOT NULL, cm VARCHAR(255) DEFAULT NULL, tp VARCHAR(255) DEFAULT NULL, td VARCHAR(255) DEFAULT NULL, autre VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE nb_groupe_type_cours_has_cours (id INT AUTO_INCREMENT NOT NULL, horaire_type_cours_id INT DEFAULT NULL, cours_id INT DEFAULT NULL, cout_hetd_id INT DEFAULT NULL, nb_groupe_type_cours_id INT DEFAULT NULL, INDEX IDX_35711335A65025FA (horaire_type_cours_id), INDEX IDX_357113357ECF78B0 (cours_id), INDEX IDX_35711335176A8114 (cout_hetd_id), INDEX IDX_3571133527FD395D (nb_groupe_type_cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, telephone INT DEFAULT NULL, adjoint VARCHAR(255) DEFAULT NULL, actif INT DEFAULT NULL, adjoint2 VARCHAR(255) DEFAULT NULL, adjoint3 VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D6495126AC48 (mail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE workflow (id INT AUTO_INCREMENT NOT NULL, intitule VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, date_de_fin DATETIME DEFAULT NULL, date_limite DATETIME NOT NULL, cree_par VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE controle_connaissances DROP FOREIGN KEY FK_A83D5F3BA660B158');
        ...
        $this->addSql('ALTER TABLE controle_connaissances DROP FOREIGN KEY FK_A83D5F3B7ECF78B0');
